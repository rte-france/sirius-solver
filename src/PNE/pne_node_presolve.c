...
if ( Noeud->ProfondeurDuNoeud < Pne->pne_params->PROFONDEUR_MIN_POUR_NODE_PRESOLVE && Noeud->ProfondeurDuNoeud > 1 ) return;

if ( Noeud->ProfondeurDuNoeud % Pne->pne_params->CYCLE_NODE_PRESOLVE != 0 ) return;
